          ...
          {plan && !result && mode === 'quarantine' && (
            <>
              ...
              <div>
                ...
                {plan.changes.length ? (
                  <div className="rounded-lg border border-cyber-border/40 bg-[#1C1C1E] p-3 font-mono text-[11px] space-y-0.5">
            ...
            <div className="space-y-3">
              ...
              {result.result.needsInstall && (
                <div>
                  ...
                  <div className="flex items-center gap-2 font-mono text-[12px] text-slate-100 bg-[#1C1C1E] border border-cyber-border/40 rounded-lg px-3 py-2">
