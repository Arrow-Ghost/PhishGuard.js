          ...
          <div className="flex-1 w-full text-xs font-mono">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={trendData} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <XAxis dataKey="t" stroke="#6b7280" tick={{ fontSize: 9 }} />
                <YAxis stroke="#6b7280" domain={[0, 100]} />
                <Tooltip contentStyle={{ backgroundColor: '#161b26', borderColor: '#242b3d', borderRadius: 6, color: '#f1f5f9', fontFamily: 'monospace' }} />
                <Area name="Score" type="monotone" dataKey="score" stroke="#4f46e5" fillOpacity={1} fill="url(#cScore)" />
              </AreaChart>
            </ResponsiveContainer>
          </div>
        </div>
